...
const elementsToAnimate = document.querySelectorAll('[component-animation="true"]');

// Check if the user prefers reduced motion
const prefersReducedMotionNoPref = window.matchMedia('(prefers-reduced-motion: no-preference)').matches;
